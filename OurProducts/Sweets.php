...
<html>
<head>
	<title>Sweets à prix imbattable</title>
	<meta name="description" content="Sweets à prix imbattable">
						...
						<ul style="float: left;">
							<li style="float: left; padding: 0px 25px 25px 25px;">
								<div class="home-prodlist-img"><a href="./'.$pName.'-'.$id.'.html">
									<h2>MGA '.$price.' </h2>
									<img src="../image/product/sweet/'.$picture.'" class="home-prodlist-imgi" alt="Image de ppn imbattable">
									</a>
