...
<html>
<head>
	<title>Shampoo à prix imbattable</title>
	<meta name="description" content="Shampoo à prix imbattable">
						...
						<ul style="float: left;">
							<li style="float: left; padding: 0px 25px 25px 25px;">
								<div class="home-prodlist-img"><a href="./'.$pName.'-'.$id.'.html">
									<h2> MGA'.$price.'</h2>
									<img src="../image/product/shampoo/'.$picture.'" class="home-prodlist-imgi" alt="Image de ppn imbattable">
									</a>
